...
class GoodsCategory(BaseModel):
    ...
    parent = models.ForeignKey(to='self', null=True, blank=True, on_delete=models.CASCADE, verbose_name='父类')
...
class Brand(BaseModel):
    ...
    logo = models.ImageField(verbose_name='logo图片链接')
...
class Goods(BaseModel):
    ...
    brand = models.ForeignKey(to=Brand, on_delete=models.PROTECT, verbose_name='品牌')
    category1 = models.ForeignKey(to=GoodsCategory, on_delete=models.PROTECT, related_name='cat1_goods', verbose_name='一级类别')
    category2 = models.ForeignKey(to=GoodsCategory, on_delete=models.PROTECT, related_name='cat2_goods', verbose_name='二级类别')
...
class SpecificationOption(BaseModel):
    ...
    规则选项
    """
    spec = models.ForeignKey(to=GoodsSpecification, on_delete=models.CASCADE, verbose_name='规格')
...
class SKU(BaseModel):
    ...
    goods = models.ForeignKey(to=Goods, on_delete=models.CASCADE, verbose_name='商品')
    category = models.ForeignKey(to=GoodsCategory, on_delete=models.PROTECT, verbose_name='从属类别')
    ...
    default_image_url = models.CharField(max_length=200, default='', null=True, blank=True, verbose_name='默认图片链接地址')
...
class SkuSpecification(BaseModel):
    ...
    sku规格信息
    """
    sku = models.ForeignKey(to=SKU, on_delete=models.CASCADE, verbose_name='所属sku')
    spec = models.ForeignKey(to=GoodsSpecification, on_delete=models.PROTECT, verbose_name='规格')
    option = models.ForeignKey(SpecificationOption, on_delete=models.PROTECT, verbose_name='规格选项')

    class Meta:
        db_table = 'tb_sku_specification'
        verbose_name = 'sku规格信息'
        verbose_name_plural = verbose_name
