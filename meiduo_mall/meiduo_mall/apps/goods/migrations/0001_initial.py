# Generated by Django 4.2 on 2023-12-05 07:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='', verbose_name='logo图片链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc_detail', models.CharField(blank=True, max_length=500, null=True, verbose_name='详细介绍')),
                ('desc_pack', models.CharField(blank=True, max_length=500, null=True, verbose_name='包装信息')),
                ('desc_service', models.CharField(blank=True, max_length=500, null=True, verbose_name='售后服务')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.goodscategory', verbose_name='父类')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_image_url', models.CharField(blank=True, default='', max_length=200, null=True, verbose_name='默认图片链接地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.specificationoption', verbose_name='规格选项')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.sku', verbose_name='所属sku')),
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.goodsspecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': 'sku规格信息',
                'verbose_name_plural': 'sku规格信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('image', models.ImageField(upload_to='', verbose_name='图片链接地址')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.sku', verbose_name='所属sku')),
            ],
            options={
                'verbose_name': 'sku图片',
