# Generated by Django 4.2 on 2023-09-22 01:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('areas', '0002_alter_areas_options'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='city_addresse', to='areas.areas', verbose_name='市')),
                ('distinct', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='distinct_addresse', to='areas.areas', verbose_name='区')),
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='province_addresse', to='areas.areas', verbose_name='省')),
